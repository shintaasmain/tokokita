<div class="main-content">
        <section class="section">
              ...
              <div class="col-md-4">
                ...
                <li class="nav-item"><a href="<?php echo site_url('frontend/dashboard_member');?>" class="nav-link">Beranda</a></li>
                    ...
                    <li class="nav-item"><a href="<?php echo site_url('frontend/riwayat_transaksi');?>" class="nav-link">Riwayat Transaksi</a></li>
                      ...
                      <li class="nav-item"><a href="#" class="active nav-link">Ubah Profil</a></li>
          ...
          <div class="col-12">
                ...
                <div class="card-body">
                    <div>
                    <h2 class="section-title"><?php foreach ($profil as $P ):?> Hi, <?php echo $P->namaKonsumen ?><?php endforeach;?> !</h2>
                </div>
                </div>
                </div>
              </div>
            ...
            <div class="col-12">
                <?php foreach ($profil as $p):?>
                  <form method="post" enctype="multipart/form-data"  action="<?php echo site_url('frontend/ubahProfil/'.$p->idKonsumen);?>" class="needs-validation" novalidate="" >
                <div class="card">
                <div class="card-header">
                    <h4>Ubah Profil</h4>
                </div>
                <div class="card-body">
                    <input class="form-control" type="hidden" placeholder="" aria-label="Search" value="<?php echo $this->session->userdata('idKonsumen'); ?>" data-width="250" name="idKonsumen">
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama </label>
                      <div class="col-9">
                      <input class="form-control" required type="text" placeholder="" aria-label="Search" data-width="250" name="namaKonsumen" value="<?= $p->namaKonsumen?>">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-9">
                      <input class="form-control" required type="text" placeholder="" aria-label="Search" data-width="250" name="email" value="<?= $p->email ?>">
                      <div class="invalid-feedback">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-9">
                      <input class="form-control" type="text" placeholder="" aria-label="Search" data-width="250" name="tlpn" value="<?= $p->tlpn ?>" required>
                      <div class="invalid-feedback">
                      ...
                      <select class="form-control mb-3" name="idKota">
                        <?php foreach ($kota as $k): ?>
                            <option <?php if ($k->idKota == $p->idKota) { 
                              ...
                              value="<?= $k->idKota?>"><?= $k->namaKota?></option>
                        <?php endforeach; ?>
                      </select> 
                      </div>
                        </div>
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-9">
                      <input class="form-control" type="text" placeholder="" aria-label="Search" data-width="250" name="alamat" value="<?= $p->alamat ?>" required>
                      <div class="invalid-feedback">
