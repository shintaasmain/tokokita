<div class="main-content">
	<section class="section">
		<div class="section-header">
			...
			<h1>Menu Utama Dashboard Toko " <?php foreach($produk as $p): ?> <?php echo $p->namaToko;?> <?php endforeach ; ?>
				"</h1>
		</div>
		<div class="section-body">
			...
			<div class="row">
					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills flex-column">
								<li class="nav-item"><a href="<?php echo site_url('frontend/getidToko/'.$p->idToko);?>"
										class="nav-link">Beranda</a></li>
								<li class="nav-item"><a href="<?php echo site_url('frontend/produk/'.$p->idToko);?>"
										class=" active nav-link">Produk</a></li>
								<li class="nav-item"><a href="<?php echo site_url('frontend/pesanan/'.$p->idToko);?>"
										class="nav-link">Pesanan</a></li>
								<li class="nav-item"><a href="<?php echo site_url('frontend/laporanProduk');?>"
										class="nav-link">Laporan</a></li>
								<li class="nav-item"><a href="<?php echo site_url('frontend/ubah_toko/'.$p->idToko);?>"
				...
				<div class="col-md-8">
					<div class="row">
						<div class="col-12">
							<form method="post" enctype="multipart/form-data" action="<?php echo site_url('frontend/detailProduk');?>"
								...
								<div class="card">
									<div class="card-header">
										...
										<div class="card-header-action">
											<a href="<?= base_url('frontend/produk/'.$p->idToko); ?>" class="btn btn-primary">
												Kembali
											</a>
										</div>
									</div>
									<div class="card-body">
										<input class="form-control" type="hidden" placeholder="" aria-label="Search"
											value="<?php echo $p->idToko;?>" data-width="250" name="idToko">
										<input class="form-control" type="hidden" placeholder="" aria-label="Search"
											value="<?php echo $p->idProduk;?>" data-width="250" name="idProduk">
                                ...
                                echo 'selected="selected"';}?> value="<?= $Kat->idKat?>"><?= $Kat->namakat?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										<div class="form-group row mb-4">
											...
											<div class="col-9">
												<input class="form-control" type="text" placeholder="" aria-label="Search" data-width="250"
													name="namaProduk" value="<?= $p->namaProduk;?>" required>
										...
										<div class="form-group row mb-4">
											...
											<div class="col-9">
												<input class="form-control" required type="text" placeholder="" aria-label="Search"
													data-width="250" name="namaToko" value="<?= $p->namaToko;?>">
												<div class="invalid-feedback">
										...
										<div class="form-group row mb-4">
											...
											<div class="col-9">
												<input class="form-control" required type="text" placeholder="" aria-label="Search"
													data-width="250" name="hargaProduk" value="<?= $p->harga;?>">
												<div class="invalid-feedback">
										...
										<div class="form-group row mb-4">
											...
											<div class="col-9">
												<input class="form-control" required type="text" placeholder="" aria-label="Search"
													data-width="250" name="stokProduk" value="<?= $p->stok;?>">
												<div class="invalid-feedback">
										...
										<div class="form-group row mb-4">
											...
											<div class="col-9">
												<input class="form-control" required type="text" placeholder="" aria-label="Search"
													data-width="250" name="beratProduk" value="<?= $p->berat;?>">
												<div class="invalid-feedback">
										...
										<div class="form-group row mb-4">
											...
											<div class="col-9">
												<textarea class="form-control" required
													name="deskripsiProduk"><?= $p->deskripsiProduk;?></textarea>
												<div class="invalid-feedback">
